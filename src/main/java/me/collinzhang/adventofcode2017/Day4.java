...
public class Day4 {
    ...
    public static void main(String[] args) {
        System.out.println(dayFour1(DAY_FOUR));
        System.out.println(dayFour2(DAY_FOUR));
    }

    private static long dayFour1(String input) {
    ...
    private static long dayFour2(String input) {
        Scanner scanner = new Scanner(input);
        long count = 0;
        while (scanner.hasNext()) {
            int valid = 1;
